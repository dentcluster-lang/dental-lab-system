...
import {
    ...
    Edit2, X, Building2, Phone, Mail, Users, ChevronRight, CreditCard, Settings
} from 'lucide-react';
import {
        ...
        const checkPageStatus = async () => {
            try {
                ...
                if (settingsDoc.exists()) {
                    ...
                    const jobBoardStatus = data.jobBoard?.enabled;
                    setPageEnabled(jobBoardStatus !== false);
                } else {
                    setPageEnabled(true);
                }
            } catch (error) {
        ...
        return (
            <div style={styles.maintenanceContainer}>
                <div style={styles.maintenanceBox}>
                    ...
                    <h1 style={styles.maintenanceTitle}>구인공고 페이지 점검중</h1>
                    <p style={styles.maintenanceText}>
                        현재 구인공고 페이지는 점검 중입니다.<br />
                        빠른 시일 내에 정상화하겠습니다.
                    </p>
