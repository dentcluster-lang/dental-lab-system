...
import {
    ...
    Clock, CheckCircle, X, Filter, ChevronRight, Eye, Settings
} from 'lucide-react';
        ...
        const checkPageStatus = async () => {
            try {
                ...
                if (settingsDoc.exists()) {
                    ...
                    const labDirectoryStatus = data.labDirectory?.enabled;
                    setPageEnabled(labDirectoryStatus !== false);
                } else {
                    setPageEnabled(true);
                }
            } catch (error) {
        ...
        return (
            <div style={styles.maintenanceContainer}>
                <div style={styles.maintenanceBox}>
                    ...
                    <h1 style={styles.maintenanceTitle}>기공소찾기 페이지 점검중</h1>
                    <p style={styles.maintenanceText}>
                        현재 기공소찾기 페이지는 점검 중입니다.<br />
                        빠른 시일 내에 정상화하겠습니다.
                    </p>
